...
export const BUILDER_PROJECTS: BuilderProject[] = [
  ...
  },
  {
    ...
    expandedMedia: {
      src: "/developer-ai/Jhonattanrodriguez.png",
      alt: "Portada de jhonattanrodriguez.com en desktop: retrato, nombre de Jhonattan Rodriguez y los roles Developer AI, Growth Hacker y Filmmaker",
      width: 3456,
      height: 1920,
    },
